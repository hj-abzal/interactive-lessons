...
import jsoneditorIcons from './jsoneditor-icons.svg';
...
.jsoneditor-contextmenu .jsoneditor-menu li button .jsoneditor-expand {
  ...
  padding: 0;
  margin: 0 4px 0 0;
  background-image: url(${jsoneditorIcons});
...
.jsoneditor-modal .jsoneditor-transform-preview {
  ...
  consolas, monaco, "lucida console", "courier new", courier, monospace, sans-serif;
  font-size: 10pt;
  width: 100%;
  box-sizing: border-box;
}
...
.jsoneditor-search button {
  ...
  margin: 0;
  border: none;
  background: url(${jsoneditorIcons});
  vertical-align: top;
}
